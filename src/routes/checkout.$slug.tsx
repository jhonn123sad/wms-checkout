...
function CheckoutPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white p-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-2 text-white">Checkout não encontrado</h1>
  ...
  if (!checkout.active) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white p-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-2 text-white">Checkout indisponível</h1>
          <p className="text-gray-400">Este checkout não está mais ativo.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div className="space-y-8">
          <Card className="overflow-hidden border-[#333] bg-[#1a1a1a] shadow-2xl min-h-[200px]">
            <MediaDisplay media={(checkout.media_json as unknown as MediaValue) || (checkout.media_url ? { url: checkout.media_url, type: checkout.media_type as any, source: 'external' } : null)} />
          </Card>
