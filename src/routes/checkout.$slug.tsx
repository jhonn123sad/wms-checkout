 ...
 function CheckoutPage() {
     ...
     return (
       <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white p-6">
         <div className="text-center">
           <h1 className="text-2xl font-bold mb-2">Checkout não encontrado</h1>
   ...
   if (!checkout.active) {
     return (
       <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white p-6">
         <div className="text-center">
           <h1 className="text-2xl font-bold mb-2">Checkout indisponível</h1>
