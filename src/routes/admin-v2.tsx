    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      <aside className="w-full md:w-64 bg-card border-b md:border-r border-border p-6 flex flex-col gap-6 sticky top-0 h-screen">
        ...
        <nav className="flex flex-col gap-1">
          <Link to="/admin-v2/checkouts" className="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-accent [&.active]:bg-primary/10">
            <ShoppingCart className="w-4 h-4" /> Checkouts V2
          </Link>
        </nav>
      ...
      <main className="flex-1 overflow-auto bg-muted/10"><Outlet /></main>
    </div>
  );
}
